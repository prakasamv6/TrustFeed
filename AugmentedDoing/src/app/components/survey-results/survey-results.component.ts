...
@Component({
  ...
  styles: [`
    ...
    .mode-badge {
      ...
      &.collab { background: var(--cat-c-bg); color: var(--accent-purple); border-color: var(--accent-purple); }
    }

    /* Sections */
    .section {
      background: var(--bg-glass); backdrop-filter: blur(var(--blur-md));
      border-radius: var(--radius-lg); padding: 1.75rem; border: 1px solid var(--border-default);
    ...
    .truth-card {
      ...
      .tc-value { display: block; font-size: 2rem; font-weight: 700; color: var(--accent-cyan); }
      .tc-label { font-size: 0.75rem; color: var(--text-muted); }
      &.ai .tc-value { color: var(--accent-red); }
      &.human .tc-value { color: var(--accent-green); }
    }
    ...
    .comp-row {
      ...
      &.human-row { padding: 0.5rem 0; border-bottom: 1px solid var(--border-default); margin-bottom: 0.25rem; }
    }
    ...
    .comp-bar {
      ...
      &.agent-bar { background: var(--accent-tertiary); }
      &.agent-bar.better { background: linear-gradient(90deg, var(--status-confirm), var(--cat-f)); }
      &.agent-bar.worse { background: var(--status-critical); }
    }
    ...
    .donut-bg { stroke: var(--bg-elevated); }
    ...
    .os-row {
      ...
      padding: 0.4rem 0; border-bottom: 1px solid var(--bg-hover);
    }
    .os-val {
    ...
    .agent-output-card {
      padding: 1rem; border-radius: var(--radius-md); background: var(--bg-hover);
    ...
    .label-ai { color: var(--accent-red); font-weight: 600; }
    .label-human { color: var(--accent-green); font-weight: 600; }
    .cell-correct { color: var(--accent-green); font-weight: 600; }
    .cell-wrong { color: var(--accent-red); font-weight: 600; }
    ...
    .collab-btn {
      background: linear-gradient(135deg, var(--accent-tertiary), var(--label-ai)); color: var(--text-inverse);
      &:hover { box-shadow: var(--shadow-lg); }
    }
    ...
    @media (forced-colors: active) {
      ...
      .action-btn { border: 1px solid ButtonText; }
    }
